if (False):
    ...
    #This if statement is not true, so the first print doesn't happen,
    # but it instead triggers the else statement
...
if (False):
    print("This won't happen again")  
    #This if statement is not true, 
    #so it checks the elif instead
